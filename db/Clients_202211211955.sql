git addINSERT INTO BankDB.Clients (DNI,NAME,ACCOUNT_TYPE,AMOUNT,CLIENT_TYPE,ENTRY_DATE) VALUES
	 ('24690911C','Raul Montoro Abaijon','Investement account','60.200 €','Normal client','2019-10-12'),
	 ('32548795T','Alvin Miller ','Personal account','60.000 €','Normal client','2018-08-26'),
	 ('37698459X','Jose Miguel Peña','Saving account','6.000 €','Poor client','2012-01-12'),
	 ...
	 ('91785308J','Juan Castro García','Fixed deposit account','1.500 €','Poor client','2021-10-31'),
